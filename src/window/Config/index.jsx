...
export default function Config() {
    ...
    return (
        <>
            ...
            >
                ...
                <div className='p-[5px]'>
                    <div data-tauri-drag-region='true'>
                        <img alt='pot logo' src='icon.svg' className='h-[60px] w-[60px] m-auto mb-[30px]' draggable={false} />
                    </div>
                </div>
                <SideBar />
            </Card>
            ...
            >
                <div data-tauri-drag-region='true' className='top-[5px] left-[235px] right-[5px] h-[30px] fixed' />
