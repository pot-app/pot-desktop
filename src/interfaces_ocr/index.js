...
import * as _iflytek_universal from './iflytek';
import * as _iflytek_universal_intsig from './iflytek_intsig';
...
export const iflytek_universal = _iflytek;
export const iflytek_universal_intsig = _iflytek_intsig;
