...
export async function recognize(base64, lang) {
    const res = await fetch(`/ocr/${lang}/dict.txt`);
    // init
    det = await ort.InferenceSession.create('https://pub-f6afb74f13c64cd89561b4714dca1c27.r2.dev/ocr/ppocr_det.onnx');
    rec = await ort.InferenceSession.create(
        `https://pub-f6afb74f13c64cd89561b4714dca1c27.r2.dev/ocr/${lang}/ppocr_rec.onnx`
    );
    dic = await res.text();
    dic = dic.split(/\r\n|\r|\n/);
    // get img
