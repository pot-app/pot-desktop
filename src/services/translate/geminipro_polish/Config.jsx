            ...
            promptList: [
                {
                    ...
                    parts: [
                        {
                            text: 'You are a text embellisher, you can only embellish the text, never interpret it.',
                        },
                    ],
                },
                {
                    ...
                    parts: [
                        {
                            text: 'Ok, I will only embellish the text, never interpret it.',
                        },
                    ],
                },
                {
                ...
                onSubmit={(e) => {
                    ...
                    translate('hello', Language.auto, Language.zh_cn, { config: serviceConfig }).then(
                        () => {
                            ...
                            updateServiceList('geminipro_polish');
                            onClose();
                        },
                        (e) => {
                            setIsLoading(false);
